  ...
  return (
    <div className="flex flex-col justify-center items-center mt-5 lg:h-4/5">
      ...
      <div className="flex lg:flex-row flex-col justify-center items-center bg-sd_l_bg_default dark:bg-gh-bg-default lg:p-5 p-3 lg:w-4/5 w-full">
        <div className="bg-sd_l_bg_secondary dark:bg-gh-bg-secondary p-3 flex flex-0 7 w-full rounded-lg">
          {/* Border dotted Rectangle */}
          <div className="flex justify-center items-center flex-col border-2 border-dotted border-gray-300 dark:border-slate-800/70 p-3 w-full h-420">
            {loading && <Spinner />}
